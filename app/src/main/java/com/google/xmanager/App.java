...
public class App extends Application {
    ...
    public static final String TAG = "DAndroidManager";
    ...
    private void setCrashReport() {
        ...
        Thread.setDefaultUncaughtExceptionHandler((thread, throwable) -> {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                values.put(MediaStore.Downloads.DISPLAY_NAME, "DAndroid_crash_report" + time.toEpochSecond() + ".zip");
    ...
    public void onCreate() {
        ...
        intentFilter.addAction("com.google.xmanager.NOTIFICATION");
            ...
            public void onReceive(Context context, Intent inIntent) {
                ...
                switch (intent.getAction()) {
                    case Intent.ACTION_PACKAGE_ADDED, Intent.ACTION_PACKAGE_CHANGED, Intent.ACTION_PACKAGE_FULLY_REMOVED, Intent.ACTION_UID_REMOVED -> {
                        ...
                        var isDAndroidModule = intent.getBooleanExtra("isDAndroidModule", false);
                        if (packageName != null) {
                            if (isDAndroidModule)
