...
public final class ModuleUtil {
    ...
    public static boolean isLegacyModule(ApplicationInfo info) {
        return info.metaData != null && info.metaData.containsKey("dandroidminversion");
    }
    ...
    public class InstalledModule {
        ...
        private InstalledModule(PackageInfo pkg, ZipFile modernModuleApk) {
            ...
            if (legacy) {
                Object minVersionRaw = app.metaData.get("dandroidminversion");
                ...
                try (modernModuleApk) {
                    var propEntry = modernModuleApk.getEntry("META-INF/dandroid/module.prop");
                    if (propEntry != null) {
                    ...
                    var scopeEntry = modernModuleApk.getEntry("META-INF/dandroid/scope.list");
                    if (scopeEntry != null) {
        ...
        public String getDescription() {
            ...
            if (legacy) {
                Object descriptionRaw = app.metaData.get("dandroiddescription");
        ...
        public List<String> getScopeList() {
            ...
            try {
                int scopeListResourceId = app.metaData.getInt("dandroidscope");
                if (scopeListResourceId != 0) {
                    list = Arrays.asList(pm.getResourcesForApplication(app).getStringArray(scopeListResourceId));
                } else {
                    String scopeListString = app.metaData.getString("dandroidscope");
            ...
            if (list != null) {
                ...
                //https://github.com/rovo89/DAndroidBridge/commit/6b49688c929a7768f3113b4c65b429c7a7032afa
                list.replaceAll(s ->
                    switch (s) {
                        case "android" -> "system";
                        case "system" -> "android";
