...
import com.google.xmanager.databinding.FragmentSettingsBinding;
import com.google.xmanager.repo.RepoLoader;
import com.google.xmanager.ui.activity.MainActivity;
import com.google.xmanager.util.BackupUtils;
import com.google.xmanager.util.CloudflareDNS;
import com.google.xmanager.util.LangList;
...
public class SettingsFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (ConfigManager.isBinderAlive()) {
            binding.toolbar.setSubtitle(String.format(LocaleDelegate.getDefaultLocale(), "%s (%d) - %s", ConfigManager.getDAndroidVersionName(), ConfigManager.getDAndroidVersionCode(), ConfigManager.getApi()));
        } else {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            if (backup != null) {
                ...
                backup.setOnPreferenceClickListener(preference -> {
                    ...
                    try {
                        backupLauncher.launch(String.format(LocaleDelegate.getDefaultLocale(), "DAndroid_%s.lsp", now.toString()));
                        return true;
