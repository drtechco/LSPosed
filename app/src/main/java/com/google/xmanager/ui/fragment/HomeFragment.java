...
package com.google.xmanager.ui.fragment;
...
import com.google.xmanager.databinding.DialogAboutBinding;
import com.google.xmanager.databinding.FragmentHomeBinding;
import com.google.xmanager.ui.dialog.BlurBehindDialogBuilder;
import com.google.xmanager.ui.dialog.FlashDialogBuilder;
import com.google.xmanager.ui.dialog.WelcomeDialog;
import com.google.xmanager.util.NavUtil;
import com.google.xmanager.util.Telemetry;
import com.google.xmanager.util.UpdateUtil;
import com.google.xmanager.util.chrome.LinkTransformationMethod;
...
public class HomeFragment extends BaseFragment implements MenuProvider {
    ...
    public void onPrepareMenu(Menu menu) {
        ...
        menu.findItem(R.id.menu_issue).setOnMenuItemClickListener(v -> {
            NavUtil.startURL(requireActivity(), "https://github.com/DAndroid/DAndroid/issues/new/choose");
            return true;
        });
    }
    ...
    private void updateStates(Activity activity, boolean binderAlive, boolean needUpdate) {
        if (binderAlive) {
            ...
            binding.statusSummary.setText(String.format(LocaleDelegate.getDefaultLocale(), "%s (%d) - %s",
                    ConfigManager.getDAndroidVersionName(), ConfigManager.getDAndroidVersionCode(), ConfigManager.getApi()));
        ...
        if (ConfigManager.isBinderAlive()) {
            binding.apiVersion.setText(String.valueOf(ConfigManager.getDAndroidApiVersion()));
            binding.api.setText(ConfigManager.isDexObfuscateEnabled() ? R.string.enabled : R.string.not_enabled);
            binding.frameworkVersion.setText(String.format(LocaleDelegate.getDefaultLocale(), "%1$s (%2$d)", ConfigManager.getDAndroidVersionName(), ConfigManager.getDAndroidVersionCode()));
        ...
        String info = activity.getString(R.string.info_api_version) +
                ...
                "\n\n" +
                activity.getString(R.string.settings_dandroid_api_call_protection) +
                "\n" +
                binding.api.getText() +
                "\n\n" +
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            binding.designAboutInfo.setText(HtmlCompat.fromHtml(getString(
                    ...
                    "<b><a href=\"https://github.com/DAndroid/DAndroid\">GitHub</a></b>",
                    "<b><a href=\"https://t.me/DAndroid\">Telegram</a></b>"), HtmlCompat.FROM_HTML_MODE_LEGACY));
