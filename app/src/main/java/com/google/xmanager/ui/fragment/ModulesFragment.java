...
import com.google.xmanager.adapters.AppHelper;
import com.google.xmanager.databinding.FragmentPagerBinding;
import com.google.xmanager.databinding.ItemModuleBinding;
import com.google.xmanager.databinding.SwiperefreshRecyclerviewBinding;
...
import com.google.xmanager.util.GlideApp;
...
public class ModulesFragment extends BaseFragment implements ModuleUtil.ModuleListener, RepoLoader.RepoListener, MenuProvider {
    ...
    class ModuleAdapter extends EmptyStateRecyclerView.EmptyStateAdapter<ModuleAdapter.ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            int installDAndroidVersion = ConfigManager.getDAndroidApiVersion();
            String warningText = null;
            if (item.minVersion == 0) {
                warningText = getString(R.string.no_min_version_specified);
            } else if (installDAndroidVersion > 0 && item.minVersion > installDAndroidVersion) {
                warningText = getString(R.string.warning_dandroid_min_version, item.minVersion);
            } else if (item.targetVersion > installDAndroidVersion) {
