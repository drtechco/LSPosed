...
import com.google.xmanager.adapters.ScopeAdapter;
...
public class ConfigManager {
    ...
    public static int getDAndroidApiVersion() {
        try {
            return LSPManagerServiceHolder.getService().getDAndroidApiVersion();
    ...
    public static String getDAndroidVersionName() {
        try {
            return LSPManagerServiceHolder.getService().getDAndroidVersionName();
        } catch (RemoteException e) {
            Log.e(App.TAG, Log.getStackTraceString(e));
            return "";
        }
    ...
    public static int getDAndroidVersionCode() {
        try {
            return LSPManagerServiceHolder.getService().getDAndroidVersionCode();
        } catch (RemoteException e) {
            Log.e(App.TAG, Log.getStackTraceString(e));
            return -1;
        }
