...
/**
 * Wrap of {@link DAndroidInterface} used by the modules for the purpose of shielding framework implementation details.
 */
public class DAndroidInterfaceWrapper implements DAndroidInterface {

    private final DAndroidInterface mBase;

    DAndroidInterfaceWrapper(@NonNull DAndroidInterface base) {
        mBase = base;
    }
