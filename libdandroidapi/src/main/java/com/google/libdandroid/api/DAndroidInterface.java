...
/**
 * DAndroid interface for modules to operate on application processes.
 */
@SuppressWarnings("unused")
public interface DAndroidInterface {
    /**
     * SDK API version.
     */
    int API = 100;
    ...
    /**
     * Interface for method / constructor hooking. DAndroid modules should define their own hooker class
    ...
    /**
     * Gets the DAndroid framework name of current implementation.
     *
    ...
    /**
     * Gets the DAndroid framework version of current implementation.
     *
    ...
    /**
     * Gets the DAndroid framework version code of current implementation.
     *
    ...
    /**
     * Gets the DAndroid framework privilege of current implementation.
     *
     ...
     * as it was before the interception by DAndroid.
     *
    ...
    /**
     * Writes a message to the DAndroid log.
     *
    ...
    /**
     * Writes a message with a stack trace to the DAndroid log.
     *
     * @param message   The log message
    ...
    /**
     * Gets remote preferences stored in DAndroid framework. Note that those are read-only in hooked apps.
     *
