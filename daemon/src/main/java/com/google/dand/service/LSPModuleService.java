...
public class LSPModuleService extends IDAndroidService.Stub {

    private final static String TAG = "DAndroidModuleService";
    ...
    public int getFrameworkPrivilege() throws RemoteException {
        ensureModule();
        return IDAndroidService.FRAMEWORK_PRIVILEGE_ROOT;
    }
    ...
    @Override
    public void requestScope(String packageName, IDAndroidScopeCallback callback) throws RemoteException {
