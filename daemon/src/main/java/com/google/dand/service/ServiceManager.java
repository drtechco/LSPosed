...
public class ServiceManager {
    public static final String TAG = "DAndroid";
    private static final File globalNamespace = new File("/proc/1/root");
    @SuppressWarnings("FieldCanBeLocal")
    private static DAndroidService mainService = null;
    ...
    public static void start(String[] args) {
        ...
        for (String arg : args) {
            if (arg.equals("--from-service")) {
                Log.w(TAG, "DAndroid daemon is not started properly. Try for a late start...");
        ...
        mainService = new DAndroidService();
        ...
        DdmHandleAppName.setAppName("com.google.dand.daemon", 0);
