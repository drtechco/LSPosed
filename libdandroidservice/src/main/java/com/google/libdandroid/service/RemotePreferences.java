...
public final class RemotePreferences implements SharedPreferences {
    ...
    private final DAndroidService mService;
    ...
    private RemotePreferences(DAndroidService service, String group) {
        this.mService = service;
        this.mGroup = group;
    }

    @Nullable
    static RemotePreferences newInstance(DAndroidService service, String group) throws RemoteException {
