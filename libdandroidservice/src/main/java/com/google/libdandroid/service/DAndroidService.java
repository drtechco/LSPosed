...
public final class DAndroidService {
    ...
    public final static class ServiceException extends RuntimeException {
        ...
        ServiceException(RemoteException e) {
            super("DAndroid service error", e);
        }
    }

    private final static Map<OnScopeEventListener, IDAndroidScopeCallback> scopeCallbacks = new WeakHashMap<>();
    ...
    public interface OnScopeEventListener {
        ...
        private IDAndroidScopeCallback asInterface() {
            return scopeCallbacks.computeIfAbsent(this, (listener) -> new IDAndroidScopeCallback.Stub() {
                @Override
    ...
    private final IDAndroidService mService;
    ...
    DAndroidService(IDAndroidService service) {
        mService = service;
    }

    IDAndroidService getRaw() {
        return mService;
    }

    /**
     * Get the DAndroid API version of current implementation.
     *
     * @return API version
    ...
    /**
     * Get the DAndroid framework name of current implementation.
     *
    ...
    /**
     * Get the DAndroid framework version of current implementation.
     *
    ...
    /**
     * Get the DAndroid framework version code of current implementation.
     *
    ...
    /**
     * Get the DAndroid framework privilege of current implementation.
     *
    ...
    /**
     * Get remote preferences from DAndroid framework. If the group does not exist, it will be created.
     *
