...
/**
 * Base class for DAndroid callbacks.
 * <p>
...
abstract public class XCallback {
     ...
     * can be set instead. The values are just for orientation though, DAndroid doesn't enforce any
    ...
    /**
     * Base class for DAndroid callback parameters.
     */
