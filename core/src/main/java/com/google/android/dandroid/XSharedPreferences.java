...
import com.google.android.dandroid.services.FileResult;
...
public final class XSharedPreferences implements SharedPreferences {
    ...
    public XSharedPreferences(String packageName, String prefFileName) {
        ...
        var m = DAndroidInit.getLoadedModules().getOrDefault(packageName, Optional.empty());
        if (m.isPresent()) {
            ...
            try {
                ...
                isModule = metaData.containsKey("dandroidminversion");
                if (isModule) {
            ...
            newModule = isModule && (dandroidminversion > 92 || dandroidsharedprefs);
        }
        if (newModule) {
