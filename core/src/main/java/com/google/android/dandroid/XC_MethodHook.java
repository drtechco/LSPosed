...
import com.google.android.dandroid.callbacks.IXUnhook;
...
public abstract class XC_MethodHook extends XCallback {
     ...
     */
    public static final class MethodHookParam<T extends Executable> extends Param {
        /**
         * @hide
         */
        @SuppressWarnings("deprecation")
    ...
    public class Unhook implements IXUnhook<XC_MethodHook> {
        ...
        @Override
        public void unhook() {
            DAndroidBridge.unhookMethod(hookMethod, XC_MethodHook.this);
        }
