 ...
 */
public final class DAndroidHelpers {
    private DAndroidHelpers() {
    }
     ...
     *
     * @see <a href="https://github.com/RinOrz/DAndroid/blob/a44e1f1cdf0c5e5ebfaface828e5907f5425df1b/benchmark/src/result/ReflectionCacheBenchmark.json">benchmarks for ART</a>
    ...
    public static Class<?> findClass(String className, ClassLoader classLoader) {
        if (classLoader == null)
            classLoader = DAndroidBridge.BOOTCLASSLOADER;
        try {
    ...
    public static XC_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        ...
        return DAndroidBridge.hookMethod(m, callback);
    }
     ...
     * {@link DAndroidBridge#hookMethod}.
     *
     ...
     * methods, e.g. to override parameters only for the outer call. The DAndroid framework uses this
