...
public class DAndroidRemotePreferences implements SharedPreferences {
    ...
    IRemotePreferenceCallback callback = new IRemotePreferenceCallback.Stub() {
        ...
        synchronized public void onUpdate(Bundle bundle) {
            ...
            synchronized (mListeners) {
                for (var key : changes) {
                    mListeners.forEach(listener -> listener.onSharedPreferenceChanged(DAndroidRemotePreferences.this, key));
                }
            }
        }
    };

    public DAndroidRemotePreferences(ILSPInjectedModuleService service, String group) throws RemoteException {
