...
public class BridgeService {
    ...
    private static final String DESCRIPTOR = "DAndroid";
    protected static final String TAG = "DAndroid Bridge";
    
    enum ACTION {
        ACTION_UNKNOWN, ACTION_SEND_BINDER, ACTION_GET_BINDER,
    }
    
    // for client
    private static IBinder serviceBinder = null;
    private static IDAndroidService service = null;
    ...
    private static void receiveFromBridge(IBinder binder) {
        ...
        service = IDAndroidService.Stub.asInterface(serviceBinder);
        try {
    ...
    public static IDAndroidService getService() {
        return service;
    }
    ...
    public static boolean replaceShellCommand(IBinder obj, int code, long dataObj, long replyObj, int flags) {
        ...
        try {
            ...
            if (!"android.app.IActivityManager".equals(descriptor) && !"com.sonymobile.hookservice.HookActivityService".equals(descriptor)) {
                return false;
            }
    ...
    public static boolean replaceActivityController(IBinder obj, int code, long dataObj, long replyObj, int flags) {
        ...
        try {
            if (!ParcelUtils.safeEnforceInterface(data, "android.app.IActivityManager") && !ParcelUtils.safeEnforceInterface(data, "com.sonymobile.hookservice.HookActivityService")) {
                return false;
            }
